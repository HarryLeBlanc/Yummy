...
Load it using eval_file (e.g,: eval_file "C:/Users/harry/Desktop/Scripting/SonicPi/YummyFillings.rb" ) 
...
Here are all the methods, grouped by purpose:
...
Melody/rhythm manipulation
  ...
  euclidiate -- applies euclidean rhythms to generate metrical sequence, in notation ([1.5, 1.5, 1]). 
    Convenience wrapper for spreadtobeats. 
...
Here are all the functions in yummyfillings, in alphabetical order, with params:
...
And here are detailed docs per method:
...
trancegate -- a trancegate that manipulates the volume up and down. 
...
tuples
  ...
  example code:  tuples(5, 2) returns [1.6, 1.6, 1.6, 1.6, 1.6]
